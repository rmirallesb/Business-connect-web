    ...
    <body>
        ...
        <div id="all" class="w3-container">
          ...
          <?php
            ...
            echo '<div id="divbtitle1"><p3>Publicar un mensaje</p3></div>';

            ?>

            <div class="sendmessage" class="w3-row-padding">
              <form action="insertsendtext.php" method="POST">
                <textarea type="text" name="text" maxlength="200" required placeholder="Texto" autofocus="autofocus" class="textmsgtext"></textarea>
            ...
            echo '<div id="divbtitle2"><p3>Negocio: </p3><p4>' .$row["business_title"]. '</p4></div>';
